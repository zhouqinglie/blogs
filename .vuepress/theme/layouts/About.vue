    ...
    <div class="container">
      ...
      <div class="author-social">
        ...
        <ModuleTransition delay="0.04" duration="0.5">
          <div v-if="recoShowModule" class="socials">
            <a href="https://github.com/GodLikeZeal" title="github" target="_blank"><i
              class="iconfont big reco-github black"></i></a>
            <a v-if="false"><i class="iconfont big reco-gitlab coral"></i></a>
            <a href="https://gitee.com/GodLikeZeal" title="gitee" target="_blank"><i
              class="iconfont big reco-mayun crimson"></i></a>
            <a href="https://www.jianshu.com/u/e2d051b6d2e9" title="简书" target="_blank"><i
              class="iconfont big reco-jianshu indianred"></i></a>
            <a href="https://www.zhihu.com/people/qian-ge-diao-63" title="知乎" target="_blank"><i
              class="iconfont big reco-zhihu lightskyblue"></i></a>
            <a v-if="false"><i class="iconfont big reco-toutiao lightsalmon"></i></a>
            <a href="https://juejin.im/user/2796746683716990" title="掘金" target="_blank"><i
              class="iconfont big reco-juejin dodgerblue"></i></a>
            <a href="https://segmentfault.com/u/zeal_5eecb699bdb08" title="思否" target="_blank"><i
              class="iconfont big reco-sf forestgreen"></i></a>
            <a v-if="false"><i class="iconfont big reco-csdn indianred"></i></a>
            <a href="https://pan.zealsay.com/zealsay/wechat.jpg" title="微信" target="_blank"><i
              class="iconfont big reco-wechat forestgreen"></i></a>
            <a href="https://pan.zealsay.com/zealsay/qq.png" title="QQ" target="_blank"><i
              class="iconfont big reco-qq lightskyblue"></i></a>
            <h1 class="longcang">一名追求技术喜欢安静的程序猿，目前在北京某互联网公司担任高级后台java开发。</h1>
          </div>
        </ModuleTransition>
        <a href="#main" class="scroll-down bounce-enter-active down-arrow"></a>
      </div>
      ...
      <div id="main" class="body">
        ...
        <div class="fan">
          ...
          <input id="jack" type="checkbox" hidden/>
          <div class="head">
            <div class="fan__engine">
              <span class="center"></span>
            </div>
            <input id="engine" type="checkbox" hidden checked/>
            <div>
              <span class="fly"></span>
              <span class="fly"></span>
              <span class="fly"></span>
              <div class="fan__blades">
                <input id="engine2" type="checkbox" hidden checked/>
                <div class="fan__blades">
